    ...
    <>
      <DataProvider>
        <nav>
          ...
          <button onClick={() => setView("equipo_medico")}> Equipo Medico</button>
          <button onClick={() => setView("formulario_contacto")}> Formulario Contacto</button>
          <button onClick={() => setView("servicios_medicos")}> Servicios Medicos</button>
